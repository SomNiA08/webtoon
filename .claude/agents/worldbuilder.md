...
- 작업 요청: character-designer는 concept 확정 시 **병렬로 착수**할 수 있으므로 착수를 기다리게 하지 않는다 — world.md 확정 즉시 규칙(능력 대가·제약)을 공유해 캐릭터 능력 서술과 정합시킨다(남은 충돌은 series-plotter가 series-arc 확정 전에 조정, 출처 병기).
